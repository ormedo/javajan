...
@include('errors.success')
    ...
    <form class="form-horizontal" method="POST" action="{{url('/freelance')}}" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input required type="number" step="0.01" id="minprice" name="minprice" placeholder="Minimun Price per &euro;/Hour" class="form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input required type="number" step="0.01" id="normalprice"  name="normalprice"  placeholder="Normal Price per &euro;/Hour" class="form-control">
